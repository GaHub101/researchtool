...
**6 Arbeitslayouts, 9 Hilfslayouts.** Alle Arbeitslayouts 1000 pt breit, Thema
...
Kontext **Projects** · Formularansicht · 1000 × 720

### Kopfteil (Höhe 110)

| Objekt | Inhalt | x | y | b | h | Format |
|---|---|---|---|---|---|---|
| Titel | `Projects::Titel` | 20 | 16 | 700 | 30 | 22 pt, halbfett |
| Code | `Projects::c_Projektcode` | 820 | 20 | 160 | 20 | 12 pt, rechtsbündig, `#6B6B6B` |
| **Standortsatz** | `Projects::c_Standortsatz` | 20 | 52 | 960 | 24 | **15 pt** |
| Balken | `Projects::c_ZeitfortschrittProzent` | 20 | 84 | 380 | 14 | Steuerungsstil **Balkendiagramm**, 0–100, Farbe Akzent |
| Prognose | Textobjekt `Einreichung voraussichtlich <<Projects::c_EinreichungText>>` | 416 | 82 | 400 | 18 | 12 pt, `#6B6B6B` |
...
| ↳ Abschnittsname | `Abschnitt <<Sections::Nr>> — <<Sections::Name>>` | 8 | 4 | 600 | 22 |
| ↳ Leitfrage | `Sections::Leitfrage` | 8 | 26 | 600 | 18 |
| Portal `p_checkliste` | B-04, Filter **F-20.5**, Sortierung `StepNr, Nr`, Zeilenhöhe 46, Bildlaufleiste | 20 | 76 | 620 | 400 |
| ↳ Kontrollkästchen | `ChecklistItems::Erledigt` | 8 | 8 | 18 | 18 |
| ↳ Punkt | `ChecklistItems::Punkt` | 34 | 6 | 560 | 18 |
| ↳ Erklärung | `ChecklistItems::Erklaerung` | 34 | 24 | 560 | 18 |

Am Portal `p_checkliste` einstellen:

- **Kontrollkästchen** → *Objekt ▸ Ausblenden wenn* `ChecklistItems::IstUeberschrift = 1`
- **Erklärung** → *Ausblenden wenn* `ChecklistItems::IstUeberschrift = 1`
...
| ↳ Titel | `Nudges::Titel` | 10 | 8 | 296 | 18 |
| ↳ Text | `Nudges::Text` | 10 | 28 | 296 | 60 |
...
| ↳ Titel | `Tasks::Titel` | 8 | 2 | 700 | 18 |
| ↳ Termin | `fällig <<Tasks::Termin>>` | 780 | 2 | 160 | 18 |

---

## 2 · Layout `02 Meine Projekte`

Kontext **Projects** · **Listenansicht** · 1000 breit

### Kopfteil (Höhe 60)

Überschrift „Meine Projekte" (20 pt) links, `Get ( FoundCount ) & " Projekte"`
...
| Objekt | Inhalt | x | y | b | h | Format |
|---|---|---|---|---|---|---|
| Titel | `Projects::Titel` | 20 | 6 | 340 | 18 | Knopf → S-„Projektakte öffnen" |
| Bearbeitung | `Projects_ProjectPeople_People::c_Kurzname` | 380 | 6 | 140 | 18 | |
| Stand | `"M " & Projects::s_MonatImProjekt & "/" & Projects::BogenLaengeMonate` | 540 | 6 | 90 | 18 | |
| Zustand | `Projects::s_Zustand` | 540 | 24 | 90 | 14 | 10 pt, bedingt nach F-21 |
| Einreichung | `Projects::c_EinreichungText` | 660 | 6 | 140 | 18 | |
...
| ↳ Projekt · Person | `<<Nudges::…>>` Kopfzeile | 10 | 6 | 940 | 16 |
| ↳ Text | `Nudges::Text` | 10 | 24 | 940 | 44 |
...
> `02b Besprechungsliste` auf Kontext `Nudges` zu bauen — Listenansicht, Suchlauf
...
Kontext **Projects** · Formularansicht · 1000 × 700
...
|---|---|---|---|
| Abschnitte | `p_sections` | B-02 | — |
| Ergebnisse | `p_deliverables` | B-05 | — |
| Aufgaben | `p_tasks` | B-06 | — |
| Dokumente | `p_documents` | B-07 | — |
| Risiken | `p_risks` | B-08 | — |
| Publikation | `p_manuscripts` | B-11 | — |
| Verlauf | `p_activity` | B-10 | — |

Portal *Abschnitte*, Zeilenhöhe 30:

| Objekt | Inhalt | x | b |
|---|---|---|---|
| Nr | `Sections::Nr` | 10 | 24 |
| Name | `Sections::Name` | 44 | 260 | Knopf → S-„Abschnitt öffnen" |
| Monate | `"M " & Sections::Band_Von_Monat & "–" & Sections::Band_Bis_Monat` | 320 | 90 |
| Status | `Sections::Status` | 430 | 120 |
| Fortschritt | `Sections::c_PunkteErledigt & "/" & Sections::c_PunkteGesamt` | 570 | 70 |
...
Kontext **Sections** · Formularansicht · 1000 × 700
...
| Überschrift | `Abschnitt <<Sections::Nr>> — <<Sections::Name>>` | 160 | 12 | 500 | 26 | 18 pt halbfett |
| Monate | `"M " & Band_Von_Monat & "–" & Band_Bis_Monat` | 700 | 16 | 100 | 18 | `#6B6B6B` |
| Status | `Sections::Status` | 820 | 16 | 100 | 18 | |
| Leitfrage | `Sections::Leitfrage` | 20 | 46 | 700 | 20 | 14 pt |
...
| Text | `Sections::Zweck` | 20 | 32 | 620 | 54 |
| Überschrift | „Was hier erfahrungsgemäß schiefgeht" | 20 | 94 | 400 | 18 |
| Text | `Sections::Stolpersteine` | 20 | 114 | 620 | 54 |
| **Kasten Leitung** | Fläche `#F5F5F3` + „Worauf zu schauen ist" + `Sections::Hinweis_Leitung` | 664 | 12 | 316 | 156 |

Am Kasten: *Objekt ▸ Ausblenden wenn* `Projects::g_MeineStufe ≠ "Leitung"`.
...
|---|---|---|---|---|---|
| Portal `p_checkliste` | B-18, Sortierung `StepNr, Nr`, Zeilenhöhe 46 | 20 | 180 | 620 | 370 |
| Portal `p_ergebnisse` | B-19 | 664 | 180 | 316 | 180 |
| Portal `p_aufgaben` | B-20 | 664 | 372 | 316 | 178 |

Portalzeile der Checkliste wie in Layout 01, zusätzlich ein Notizknopf x596
→ öffnet ein **Kartenfenster** mit `ChecklistItems::Notiz`.

---

## 5 · Layout `05 Zeitachse`

Kontext **Projects** · Formularansicht · 1000 × 480
...
| ↳ Name | `Sections::Nr & " " & Sections::Name` | 8 | 6 | 200 | 18 |
| ↳ Soll-Balken | `Sections::c_BandGrafik` | 220 | 4 | 600 | 16 |
| ↳ Ist-Balken | `Sections::c_IstGrafik` | 220 | 20 | 600 | 16 |
| Legende | `▓ geplant   █ tatsächlich` | 220 | 300 | 400 | 18 |

Formeln F-22 und F-23 in [`04-formeln.md`](04-formeln.md), dazu die
Custom Function **CF-01 `Wiederhole`**.
...
Kontext **Projects** · Listenansicht · Titel, Standortsatz gekürzt, Zustand.
...
Neun leere Listenlayouts, je Tabelle eines, **ohne Objekte**. Sie dienen nur
Skripten als Kontext zum Anlegen von Datensätzen. In den Layout-Einstellungen
*Im Layout-Menü anzeigen* **abschalten**.

`90 Projects_Utility` · `91 Sections_Utility` · `92 Steps_Utility` ·
`93 ChecklistItems_Utility` · `94 SectionTemplates_Utility` ·
`95 StepTemplates_Utility` · `96 ChecklistTemplates_Utility` ·
`97 Nudges_Utility` · `98 ActivityLog_Utility`
